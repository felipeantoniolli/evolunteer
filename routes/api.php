...
Route::get('user/find-by-id/{user}', "UserController@findById");
...
Route::get("volunteer/find-by-id/{volunteer}", "VolunteerController@findById");
...
Route::get("institution/find-by-id/{institution}", "InstitutionController@findById");
...
Route::get("rating/find-by-id/{rating}", "RatingController@findById");
...
Route::get("work/find-by-id/{work}", "WorkController@findById");
...
Route::get("solicitation/find-by-id/{solicitation}", "SolicitationController@findById");
